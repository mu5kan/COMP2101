...
function error-exit {
	echo "there is error and it's time to exit." >&2
	exit 2
}
#This function displays help information if the user asks for it on the command line or gives us a bad command line
function displayhelp {
	echo -e "Usage
-h display help report
--host display host report
--domain display domain report
--ipconfig display ip info
--os display os info
--cpu display cpu info
--memory diplay memory info
--disk display disk info
--printer display printer info"
}
